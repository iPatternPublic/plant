卵叶山葱 (原变种) **Allium ovalifolium var. ovalifolium**
...
Leaf blade without white main veins, base cordate to rounded, rarely deeply cordate. Inner perianth segments narrower than outer ones, apex retuse or obtuse, sometimes irregularly denticulate. Fl. and fr. Jul--Sep. 2* n* = 16*, 24*.
...
### Synonym
* Allium prattii* C. H. Wright var. * latifoliatum* F. T. Wang & T. Tang.
