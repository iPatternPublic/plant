薄萼马蓝 **Strobilanthes latisepala** Hemsley J. Linn. Soc., Bot. 26: 241. 1890.
...
> Reference: 
>*Strobilanthes latisepala* is only known from the type and is possibly conspecific with the very variable *S. atropurpurea*, from which it can be distinguished by its distinctive broad sepals.*Strobilanthes latisepala* is only known from the type and is possibly conspecific with the very variable *S. atropurpurea*, from which it can be distinguished by its distinctive broad sepals.
